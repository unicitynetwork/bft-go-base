...
func (a *alwaysValid) Validate(uc *UnicityCertificate, shardConf *PartitionDescriptionRecord, trustBase RootTrustBase) error {
	return nil
}

func (a *alwaysInvalid) Validate(uc *UnicityCertificate, shardConf *PartitionDescriptionRecord, trustBase RootTrustBase) error {
...
func TestVerifyUnitStateProof(t *testing.T) {
	...
	t.Run("unit state proof is nil", func(t *testing.T) {
		...
		require.EqualError(t, usp.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid unit state proof: unit state proof is nil")
	})

	t.Run("unit ID missing", func(t *testing.T) {
		data := &UnitState{}
		usp := &UnitStateProof{}
		require.EqualError(t, usp.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid unit state proof: unit ID is unassigned")
	})
	...
	t.Run("unit tree cert missing", func(t *testing.T) {
		...
		data := &UnitState{}
		require.EqualError(t, proof.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid unit state proof: unit tree cert is nil")
	})
	...
	t.Run("state tree cert missing", func(t *testing.T) {
		...
		data := &UnitState{}
		require.EqualError(t, proof.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid unit state proof: state tree cert is nil")
	})
	...
	t.Run("unicity certificate missing", func(t *testing.T) {
		...
		data := &UnitState{}
		require.EqualError(t, proof.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid unit state proof: unicity certificate is nil")
	})
	...
	t.Run("invalid unicity certificate", func(t *testing.T) {
		...
		data := &UnitState{}
		require.EqualError(t, proof.Verify(crypto.SHA256, data, &alwaysInvalid{}, nil, nil), "invalid unicity certificate: invalid uc")
	})
	...
	t.Run("missing unit data", func(t *testing.T) {
		...
		require.EqualError(t, proof.Verify(crypto.SHA256, nil, &alwaysValid{}, nil, nil), "unit state is nil")
	})
	...
	t.Run("unit data hash invalid", func(t *testing.T) {
		...
		data := &UnitState{}
		require.EqualError(t, proof.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "unit state hash does not match unit state hash in unit tree cert")
	})
	...
	t.Run("invalid summary value", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.EqualError(t, proof.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid summary value: expected 01, got 0000000000000000")
	})
	...
	t.Run("invalid state root hash", func(t *testing.T) {
		...
		proof.UnicityCertificate, err = uc.MarshalCBOR()
		require.NoError(t, err)
		require.ErrorContains(t, proof.Verify(crypto.SHA256, data, &alwaysValid{}, nil, nil), "invalid state root hash")
	})
	...
	t.Run("verify - ok", func(t *testing.T) {
		...
		proof.UnicityCertificate, err = uc.MarshalCBOR()
		require.NoError(t, err)
		require.NoError(t, proof.Verify(crypto.SHA256, unitState, &alwaysValid{}, nil, nil), "unexpected error")
	})
}
